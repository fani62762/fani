...
class LocU extends StatefulWidget {
  const LocU({required this.LocUName, super.key});
  final String LocUName;
  @override
  State<LocU> createState() => _LocUState();
}
...
class _LocUState extends State<LocU> {
    ...
    return Scaffold(
      ...
      body: OpenStreetMapSearchAndPick(
        ...
        onPicked: (pickedData) {
          ...
          ads = ads.trim().replaceAll(new RegExp(r',$'), '');
          print(ads);
